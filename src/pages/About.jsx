        ...
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] mx-auto">
          ...
          <div className="grid grid-cols-4 md-lg:grid-cols-2 sm:grid-cols-1 gap-6 mt-12">
            {features.map((f, i) => (
              <div
                key={i}
                className="bg-white border rounded-md p-6 flex flex-col items-center text-center gap-3 hover:shadow-md transition"
              >
                <span className="text-3xl text-[#059473]">{f.icon}</span>
                <h3 className="font-bold text-lg text-slate-700">{f.title}</h3>
